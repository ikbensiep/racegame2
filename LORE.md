...
According to gamedev YouTube We need to make Small Games, which is why the plans for this are huge and ambitious and, of course, still somewhat vague. Keepin' it small & real with incremental updates, because the end goal is too much fun to lose out of sight. I'll document it properly here, "one day", "haha", "yeah", anyway there's some scattered pen&paper notes and `.md` files arounmd my desk so.
